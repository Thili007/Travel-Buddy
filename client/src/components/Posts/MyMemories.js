...
import { deletePost, getUserPosts } from "../../actions/posts";
import { setLoading } from "../../reducers/pageLoader";
import { deletedPost, getPostID } from "../../reducers/posts";
...
const MyMemories = () => {
  ...
  console.log("posts my memories", posts);
